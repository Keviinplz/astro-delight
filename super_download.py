...
def download_data_by_channel_and_metadata(
    channel: PanstarrsChannel, meta: PanstarrsImageMetadata, path_to_save: str
) -> DownloadResult:
...
async def main():
    ...
    with ProcessPoolExecutor() as executor:
        ...
        path = os.path.join(
            DATADIR_SOURCE, "coords_all_data_nlevels5_maskFalse_objectsTrue.pkl"
        )
        ...
        results: list[DownloadResult] = cast(
            list[DownloadResult],
